...
```bash
docker run --privileged -itd --name udocker -p 9002:9002 -v /var/run/docker.sock:/var/run/docker.sock  docker.llody.cn/llody/udocker:latest
```
...
```bash
mkdir /opt/udocke_db
docker run --privileged -itd --name udocker -p 9002:9002 -v /var/run/docker.sock:/var/run/docker.sock -v /opt/udocke_db:/app/db  docker.llody.cn/llody/udocker:latest
```
...
```bash
mkdir /opt/udocke_db
docker run --privileged -itd --name udocker -p 9002:9002 -v /var/run/docker.sock:/var/run/docker.sock -v /opt/udocke_db:/app/db  swr.cn-southwest-2.myhuaweicloud.com/llody/udocker:latest 
```
...
!\[1]\(./docs/images/1.png null)

### 镜像管理

!\[2]\(./docs/images/2.png null)

### 容器管理

!\[3]\(./docs/images/3.jpg null)

### 网络管理

!\[4]\(./docs/images/4.jpg null)

### 存储管理

!\[5]\(./docs/images/5.jpg null)

### 事件中心

!\[6]\(./docs/images/6.jpg null)

### 镜像仓库管理

!\[7]\(./docs/images/7.jpg null)

### 创建容

!\[8]\(./docs/images/8.png null)

### 创建网络

!\[9]\(./docs/images/9.jpg null)

### 创建挂载信息

!\[10]\(./docs/images/10.jpg null)

### 主机终端管理

!\[11]\(./docs/images/11.png null)

### Linux文件管理器

!\[12]\(./docs/images/12.jpg null)

### 文件批量上传

!\[13]\(./docs/images/13.jpg null)
...
[!\[Stargazers over time\](https://starchart.cc/llody55/udocker.svg null)](https://github.com/llody55/udocker)
